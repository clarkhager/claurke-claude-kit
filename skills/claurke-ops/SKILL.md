...
The canonical operational reference is `claurke-claude-kit/docs/operating-manual.md`. Eight sections:
...
2. Daily operations - using each product day-to-day, cross-product handoff
...
2. **Cite which section your answer comes from.** When answering, name the section ("per section 6, Troubleshooting..." or "this is in the Decision log" or "per section 1, Layering model"). Gives Clark a way to verify and lets him jump straight to the source.
